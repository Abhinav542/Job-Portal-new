...
//     e.preventDefault();
//     navigate(`/jobs?title=${jobTitle}&location=${location}&exp=${experience}`);
//   };
...
//             <p>Join thousands of professionals finding their dream jobs every day.</p>
...
const Hero = ({ user }) => {   // ✔ Accept user prop only once
  const [jobTitle, setJobTitle] = useState("");
  const [location, setLocation] = useState("");
  const [experience, setExperience] = useState("");
  ...
  return (
    <>
      ...
      <section className="how-we-work">
        ...
        <div className="content">
          <p>
            "This dynamic section showcases the most in-demand and rapidly growing job categories..."
          </p>
        </div>
      </section>
